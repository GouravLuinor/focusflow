...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col h-screen w-64 fixed left-0 top-0 z-40 bg-transparent border-r border-[#E8E6E1]/50 py-8">
      {/* Brand */}
      <div className="px-8 mb-12">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-medium text-[#1A1A1A] tracking-tight leading-tight">
              FocusFlow
            </h1>
            <p className="text-[12px] font-medium text-[#9E988E] mt-0.5">
              One task at a time
            </p>
          </div>
        </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive
                  ? 'text-[#4F46E5] border-l-4 border-[#4F46E5] bg-white shadow-[0_0_0_2px_rgba(79,70,229,0.15)]'
                  : 'text-[#6B6660] hover:bg-[#eae6f4] hover:text-[#1A1A1A]'
              )
            }
          >
            {({ isActive }) => (
              <>
                <Icon
                  className={cn(
                    ...
                    isActive ? 'text-[#4F46E5]' : 'text-[#6B6660]'
                  )}
                />
